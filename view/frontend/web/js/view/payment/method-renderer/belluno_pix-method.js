define([
    ...
    return Component.extend({
        defaults: {
            active: false,
            template: 'Belluno_Magento2/payment/belluno_pix-form',
            clientDocument: ""
        },
        ...
        getExpirationDays: function() {
            return window.checkoutConfig.bellunopix[this.getCode()].expiration_days;
        },

        getTaxDocument() {
            return window.checkoutConfig.bellunopix[this.getCode()].tax_document;
        },
