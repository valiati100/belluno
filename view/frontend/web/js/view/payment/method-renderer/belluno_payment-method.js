    ...
    return Component.extend({
        ...
        initialize: function() {
            ...
            (function afterLoadForm() {
                if ($('#bellunocc-form').length == 0) {
                    setTimeout(afterLoadForm, 50);
                } else {
                    ...
                    tel.mask("(00) 00000-0009", {clearIfNotMatch: true});
                    ...
                    self.clientDocument.subscribe(function(value) {
                        ...
                        cliD.mask(typeMaskVat, {
                            clearIfNotMatch: true
                        });
                    });

                    self.cardHolderDocument.subscribe(function(value) {
                        var typeMaskVat = value.replace(/\D/g, "").length <= 11 ? "000.000.000-009" : "00.000.000/0000-00";
