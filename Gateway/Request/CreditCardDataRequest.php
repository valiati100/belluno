...
class CreditCardDataRequest implements BuilderInterface
{
    ...
    public function build(array $buildSubject)
    {
        ...
        $this->validations($clientDocument, $cardHolderDocument, $additionalInformation["card_number"], $additionalInformation["cc_cvv"]);
        ...
        $result = [
            self::TRANSACTION => [
                ...
                self::VISITOR_ID => isset($additionalInformation["visitor_id"]) ? $additionalInformation["visitor_id"] : "",
