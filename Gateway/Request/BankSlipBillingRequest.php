...
class BankSlipBillingRequest implements BuilderInterface {
  ...
  public function build(array $buildSubject) {
    ...
    isset($additionalInformation['billing_address']) ? $street = $additionalInformation['billing_address'] : $street = '';
    isset($additionalInformation['billing_number']) ? $number = $additionalInformation['billing_number'] : $number = '';
    isset($additionalInformation['billing_district']) ? $district = $additionalInformation['billing_district'] : $district = '';
    $city = $billingAddress->getCity();
    $state = $billingAddress->getRegionCode();

    $this->_credentialValidator->validateBilling($postalCode, $street, $number, $city, $state, $district);
