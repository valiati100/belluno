...
class AcceptPaymentHandlerCc implements HandlerInterface {
  ...
  public function handle(array $handlingSubject, array $response) {
    ...
    if ($status == 'Paid' || $status == 'Client Manual Analysis' || $status == 'Manual Analysis') {
      ...
      $payment->setAdditionalInformation('transaction_data', $transaction);
      ...
      throw new CouldNotSaveException(__('An error has occurred. Check your card details!'));
    }
  }
}
